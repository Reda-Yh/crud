		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Vos donnée<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="3-formulaire.php">Rendez-vous</a></li>
							<li><a href="4-tables.php">Table de donnée</a></li>
						</ul>
					</li>
